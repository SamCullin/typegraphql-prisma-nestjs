...
function generateEnumFromDef(project, baseDirPath, enumDef) {
  return __awaiter(this, void 0, void 0, function () {
    var dirPath, filePath, sourceFile, documentation;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          filePath = path_1["default"].resolve(dirPath, enumDef.name + ".ts");
          ...
          sourceFile.addEnum(
            __assign(
              __assign(
                { isExported: true, name: enumDef.name },
                documentation && {
                  docs: [{ description: documentation }],
                },
              ),
              {
                members: enumDef.values.map(function (enumValue) {
                  return {
                    name: enumValue,
                    value: enumValue,
                  };
