...
function generateActionResolverClass(
  project,
  baseDirPath,
  model,
  operationKind,
  ...
  return __awaiter(this, void 0, void 0, function () {
    var actionResolverName, resolverDirPath, filePath, sourceFile;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          actionResolverName = helpers_1.pascalCase(method.name) + "Resolver";
          ...
          imports_1.generateModelsImports(
            sourceFile,
            [model.name, outputTypeName].filter(function (name) {
          ...
          imports_1.generateOutputsImports(
            sourceFile,
            [outputTypeName].filter(function (name) {
              return !modelNames.includes(name);
            }),
            2,
          );
          sourceFile.addClass({
            ...
            methods: [
              helpers_2.generateCrudResolverClassMethodDeclaration(
                operationKind,
                actionName,
                method,
                argsTypeName,
        ...
        case 1:
          _a.sent();
          return [2 /*return*/, actionResolverName];
      }
    });
  });
}
